...
os.chdir("C:\\Users\\UTENTE\\Google Drive laptop\\LUCAS Copernicus\\EarthEngine\\TRAJECTORIES Germany\\data")
ee.Authenticate(auth_mode='localhost')
ee.Initialize(project='landcovercopernicus')

# Input points
df = pd.read_csv("Germany_master_points.csv")
...
for month in range(1, 13):
    ...
    df_month.to_csv(f"2018\\S2_S1_Germany_2018_{month:02d}.csv", index=False)
...
if monthly_dfs:
    ...
    df_final.to_csv("S2_S1_Germany_2018_Monthly.csv", index=False)
    print("✅ File finale salvato: S2_S1_Germany_2018_Monthly.csv")
else:
    print("❌ Nessun dato valido per il 2018: nessun file unificato generato.")
