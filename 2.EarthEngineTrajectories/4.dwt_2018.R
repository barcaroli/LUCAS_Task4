...
# b <- fread(paste0(datapath,"S2_S1_Italy_2018_trajectories_dwt_master.csv"))

s <- fread(paste0(datapath,"S2_S1_Italy_2018_trajectories_sample.csv"))
b <- merge(df,dtw,by="POINT_ID")
s2018 <- fread(paste0(datapath,"Survey_2018_cal_wgt.txt"))
b <- merge(b,s2018[,c("POINT_ID","land_cover")],by="POINT_ID")
