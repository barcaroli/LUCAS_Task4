...
# Read 2018 sample
s <- read.delim("D:/Google Drive/LUCAS Copernicus/EarthEngine/data/Survey_2018_cal_wgt.txt")
s <- s[s$NUTS0_16 == "IT",]
...
glcm <- read.csv("D:/Google Drive/LUCAS Copernicus/EarthEngine/1.EarthEngineDownload/S2_S1_GLCM_Italy_2018.csv")
...
traj <- read.csv("D:/Google Drive/LUCAS Copernicus/EarthEngine/2.EarthEngineTrajectories/S2_S1_Italy_2018_trajectories_master.csv")
...
write.table(italy,"D:/Google Drive/LUCAS Copernicus/EarthEngine/3.MachineLearning/Italy_master_2018.csv",sep=",",quote=F,row.names=F)

sample <- merge(italy,s[,c("POINT_ID","LC1")])
write.table(sample,"D:/Google Drive/LUCAS Copernicus/EarthEngine/3.MachineLearning/Italy_sample_2018.csv",sep=",",quote=F,row.names=F)
