...
write.table(mpred,paste0(datapath,"Italy_master_2018_with_predictions_2.csv"),sep=",",quote=F,row.names=F)
library(data.table())
...
write.table(mat,paste0(datapath,"Italy_estimates_predictions_2018_2.csv"),sep=",",quote=F,row.names=F)
