...
write.table(mpred,"Italy_master_2022_with_predictions.csv",sep=",",quote=F,row.names=F)
...
write.table(mat,"Italy_estimates_predictions_2022.csv",sep=",",quote=F,row.names=F)
