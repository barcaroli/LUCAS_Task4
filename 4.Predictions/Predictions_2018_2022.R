...
mat <- rbind(mat1[1,],mat2[1,],mat2[2,],mat1[3,],mat2[4,])
...
barplot(mat,
        beside = TRUE,
        col = c("skyblue","magenta", "orange","darkgreen","yellow"),
        ylim = c(0, max(mat) + 5),
        names.arg = c("A", "B", "C", "D", "E", "F", "G", "H"),
        ylab = "Percentage",
        main = "Predicted and observed 2018 and 2022")

legend("topright", legend = c("Master Predicted 2018", "Master predicted 2022", "Master predicted corrected 2022",
                              "Survey 2018","Survey 2022"), 
       fill = c("skyblue", "magenta", "orange","darkgreen","yellow"))
...
barplot(m2a,
        ...
        names.arg = c("A", "B", "C", "D", "E", "F", "G", "H"),
        ylab = "Percentage",
        main = "Predicted (corrected) and observed 2022")

legend("topright", legend = c("Master predicted corrected 2022",
                              "Survey 2022"), 
       fill = c("orange","yellow"))
...
legend("topright", legend = c("Master predicted corrected 2018",
                              "Master predicted 2022"), 
       fill = c("orange","yellow"))
