...
load(paste0(datapath,"ensemble_model_A.RData"))
...
s2 <- s2[substr(s2$SURVEY_LC1,1,1) == "A",]
...
write.table(mat,paste0(datapath,"Italy_estimates_predictions_2022_A.csv"),sep=",",quote=F,row.names=F)
