...
mat1 <- read.csv(paste0(datapath,"Italy_estimates_predictions_2018_A.csv"),dec=".")
mat2 <- read.csv(paste0(datapath,"Italy_estimates_predictions_2022_A.csv"),dec=".")

mat <- rbind(mat1[1,],mat2[1,],mat1[3,],mat2[3,])
mat <- as.matrix(mat[, 1:3])
mat
